 ...
 * incremental push synchronization, that it has finished applying the rsync delta (temp->basis
 * move) for a single file.
 * <br>One event is sent per completed file modification.
 * <br>This is the reverse-direction counterpart of {@link CMFileSyncEventCompletePullModify},
 * which the client sends to the server in the pull synchronization.
 * @author CCSLab, Konkuk University
 */
public class CMFileSyncEventCompletePushModify extends CMFileSyncEvent {
    // Fields: modifiedPath
    private String modifiedPath;    // modified file path relative to sync home

    public CMFileSyncEventCompletePushModify() {
        m_nID = CMFileSyncEvent.COMPLETE_PUSH_MODIFY;
        modifiedPath = null;
    }

    public CMFileSyncEventCompletePushModify(ByteBuffer msg) {
        this();
        unmarshall(msg);
    }
    ...
    public String toString() {
        return "CMFileSyncEventCompletePushModify{" +
                "m_nType=" + m_nType +
    ...
    public boolean equals(Object o) {
        ...
        CMFileSyncEventCompletePushModify that = (CMFileSyncEventCompletePushModify) o;
