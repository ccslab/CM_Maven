 ...
 * of the pull synchronization to the server.
 * @author CCSLab, Konkuk University
 */
public class CMFileSyncEventCompletePullSyncAck extends CMFileSyncEvent {
    // Fields: numFilesCompleted, returnCode
    private int numFilesCompleted;  // number of completed pull-sync entries reported by the server
    private int returnCode;         // client-side pull-sync completion result (1: success, 0: failure)

    public CMFileSyncEventCompletePullSyncAck() {
        m_nID = CMFileSyncEvent.COMPLETE_PULL_SYNC_ACK;
        numFilesCompleted = 0;
        returnCode = -1;
    }

    public CMFileSyncEventCompletePullSyncAck(ByteBuffer msg) {
        this();
        unmarshall(msg);
    }
    ...
    public String toString() {
        return "CMFileSyncEventCompletePullSyncAck{" +
                "m_nType=" + m_nType +
    ...
    public boolean equals(Object o) {
        ...
        CMFileSyncEventCompletePullSyncAck that = (CMFileSyncEventCompletePullSyncAck) o;
    ...
    /**
     * gets the number of completed pull-sync entries reported by the server.
