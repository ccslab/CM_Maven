...
/**
 * This class represents a CMFileSyncEvent with which the server acknowledges the completion
 * of receiving all push (client) entry lists for incremental push synchronization. The
 * server-side entry-count verification result is returned via {@code returnCode}.
 * <br>This is the reverse-direction counterpart of {@link CMFileSyncEventEndServerEntryListAck},
 * which the client sends to the server in the pull synchronization.
 * @author CCSLab, Konkuk University
 */
public class CMFileSyncEventEndPushEntryListAck extends CMFileSyncEvent {
    private int numFilesCompleted;  // number of files completed
    private int returnCode;         // return code

    public CMFileSyncEventEndPushEntryListAck() {
        m_nID = CMFileSyncEvent.END_PUSH_ENTRY_LIST_ACK;
        numFilesCompleted = 0;
        returnCode = -1;
    }

    public CMFileSyncEventEndPushEntryListAck(ByteBuffer msg) {
        this();
        unmarshall(msg);
    }
    ...
    public String toString() {
        return "CMFileSyncEventEndPushEntryListAck{" +
                "m_nType=" + m_nType +
                ", m_nID=" + m_nID +
    ...
    public boolean equals(Object o) {
        ...
        CMFileSyncEventEndPushEntryListAck that = (CMFileSyncEventEndPushEntryListAck) o;
