...
public class CMFileSyncEventEndServerEntryListAckTest {
    @Test
    public void marshallUnmarshall() {
        System.out.println("===== CMFileSyncEventEndServerEntryListAckTest.marshallUnmarshall() called..");
        CMFileSyncEventEndServerEntryListAck fsEvent = new CMFileSyncEventEndServerEntryListAck();
        ...
        CMFileSyncEventEndServerEntryListAck unmarshallEvent =
                (CMFileSyncEventEndServerEntryListAck) CMEventManager.unmarshallEvent(byteBuffer);
