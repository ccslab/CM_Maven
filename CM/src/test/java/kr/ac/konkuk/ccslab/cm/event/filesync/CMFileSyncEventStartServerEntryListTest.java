...
public class CMFileSyncEventStartServerEntryListTest {
    @Test
    public void marshallUnmarshall() {
        System.out.println("===== CMFileSyncEventStartServerEntryListTest.marshallUnmarshall() called..");
        CMFileSyncEventStartServerEntryList fsEvent = new CMFileSyncEventStartServerEntryList();
        ...
        CMFileSyncEventStartServerEntryList unmarshallEvent =
                (CMFileSyncEventStartServerEntryList) CMEventManager.unmarshallEvent(byteBuffer);
