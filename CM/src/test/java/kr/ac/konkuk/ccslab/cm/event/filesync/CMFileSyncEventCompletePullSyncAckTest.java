...
public class CMFileSyncEventCompletePullSyncAckTest {
    @Test
    public void marshallUnmarshall() {
        System.out.println("===== CMFileSyncEventCompletePullSyncAckTest.marshallUnmarshall() called..");
        CMFileSyncEventCompletePullSyncAck fsEvent = new CMFileSyncEventCompletePullSyncAck();
        ...
        CMFileSyncEventCompletePullSyncAck unmarshallEvent =
                (CMFileSyncEventCompletePullSyncAck) CMEventManager.unmarshallEvent(byteBuffer);
