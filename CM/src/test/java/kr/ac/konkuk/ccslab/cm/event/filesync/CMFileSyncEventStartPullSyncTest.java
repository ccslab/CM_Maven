...
public class CMFileSyncEventStartPullSyncTest {
    @Test
    public void marshallUnmarshall() {
        System.out.println("===== CMFileSyncEventStartPullSyncTest.marshallUnmarshall() called..");
        CMFileSyncEventStartPullSync fsEvent = new CMFileSyncEventStartPullSync();
        ...
        fsEvent.setCursor(1234L);
        System.out.println("fsEvent = " + fsEvent);

        ByteBuffer byteBuffer = CMEventManager.marshallEvent(fsEvent);
        CMFileSyncEventStartPullSync unmarshallEvent =
                (CMFileSyncEventStartPullSync) CMEventManager.unmarshallEvent(byteBuffer);
        ...
        assertEquals(1234L, unmarshallEvent.getCursor());
