...
public class CMOpenBlockSocketChannelTask implements Callable<SocketChannel> {
	private int m_nChType;
	private String m_strServerAddress;
	private int m_nServerPort;
	private CMInfo m_cmInfo;
	
	public CMOpenBlockSocketChannelTask(int nChType, String strServerAddress, int nServerPort, CMInfo cmInfo)
	{
		m_nChType = nChType;
	...
	public SocketChannel call()
	{
		...
		try {
			sc = (SocketChannel) CMCommManager.openBlockChannel(m_nChType, 
